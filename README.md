...
[![License](https://img.shields.io/badge/license-GPLv3-blue.svg)](LICENSE) [![Version](https://img.shields.io/badge/version-0.4.3-lightgrey.svg)](frontend/package.json) [![GitHub Pages](https://img.shields.io/badge/GitHub%20Pages-deployed-brightgreen.svg)](https://Henrikbch1.github.io/time-tracker/)
...
**Aktueller Release:** 0.4.3 — Verbesserte Statistiken, Einstellungen und Mobile-Optimierungen.

**Wichtigste Neuerungen (0.4.3)**
...
- 0.4.3 — Statistik- und Settings-Updates, Mobile-Verbesserungen.
